...
-- Name: csw_harvester; Type: DATABASE; Schema: -; Owner: csw_harvester
--

CREATE DATABASE csw_harvesterafter WITH TEMPLATE = template0 ENCODING = 'UTF8';


ALTER DATABASE csw_harvesterafter OWNER TO csw_harvester;

\connect csw_harvesterafter
...
-- Name: contact; Type: TABLE; Schema: public; Owner: csw_harvester; Tablespace:
--
...
ALTER TABLE public.contact OWNER TO csw_harvester;

--
-- TOC entry 171 (class 1259 OID 49217)
-- Name: contact_id_dataidentification_seq; Type: SEQUENCE; Schema: public; Owner: csw_harvester
--
...
ALTER TABLE public.contact_id_dataidentification_seq OWNER TO csw_harvester;

--
-- TOC entry 2007 (class 0 OID 0)
-- Dependencies: 171
-- Name: contact_id_dataidentification_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: csw_harvester
--
...
-- Name: dataidentification; Type: TABLE; Schema: public; Owner: csw_harvester; Tablespace:
--
...
ALTER TABLE public.dataidentification OWNER TO csw_harvester;

--
-- TOC entry 173 (class 1259 OID 49222)
-- Name: dataidentification_id_dataidentification_seq; Type: SEQUENCE; Schema: public; Owner: csw_harvester
--
...
ALTER TABLE public.dataidentification_id_dataidentification_seq OWNER TO csw_harvester;

--
-- TOC entry 2008 (class 0 OID 0)
-- Dependencies: 173
-- Name: dataidentification_id_dataidentification_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: csw_harvester
--
...
-- Name: extraction; Type: TABLE; Schema: public; Owner: csw_harvester; Tablespace:
--
...
ALTER TABLE public.extraction OWNER TO csw_harvester;

--
-- TOC entry 175 (class 1259 OID 49227)
-- Name: extraction_id_sdi_seq; Type: SEQUENCE; Schema: public; Owner: csw_harvester
--
...
ALTER TABLE public.extraction_id_sdi_seq OWNER TO csw_harvester;

--
-- TOC entry 2009 (class 0 OID 0)
-- Dependencies: 175
-- Name: extraction_id_sdi_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: csw_harvester
--
...
-- Name: geographicboundingbox; Type: TABLE; Schema: public; Owner: csw_harvester; Tablespace:
--
...
ALTER TABLE public.geographicboundingbox OWNER TO csw_harvester;

--
-- TOC entry 177 (class 1259 OID 49232)
-- Name: geographicboundingbox_id_geographicboundingbox_seq; Type: SEQUENCE; Schema: public; Owner: csw_harvester
--
...
ALTER TABLE public.geographicboundingbox_id_geographicboundingbox_seq OWNER TO csw_harvester;

--
-- TOC entry 2010 (class 0 OID 0)
-- Dependencies: 177
-- Name: geographicboundingbox_id_geographicboundingbox_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: csw_harvester
--
...
-- Name: keyword; Type: TABLE; Schema: public; Owner: csw_harvester; Tablespace:
--
...
ALTER TABLE public.keyword OWNER TO csw_harvester;

--
-- TOC entry 179 (class 1259 OID 49240)
-- Name: keyword_id_keyword_seq; Type: SEQUENCE; Schema: public; Owner: csw_harvester
--
...
ALTER TABLE public.keyword_id_keyword_seq OWNER TO csw_harvester;

--
-- TOC entry 2011 (class 0 OID 0)
-- Dependencies: 179
-- Name: keyword_id_keyword_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: csw_harvester
--
...
-- Name: metadata; Type: TABLE; Schema: public; Owner: csw_harvester; Tablespace:
--
...
ALTER TABLE public.metadata OWNER TO csw_harvester;

--
-- TOC entry 181 (class 1259 OID 49248)
-- Name: metadata_id_metadata_seq; Type: SEQUENCE; Schema: public; Owner: csw_harvester
--
...
ALTER TABLE public.metadata_id_metadata_seq OWNER TO csw_harvester;

--
-- TOC entry 2012 (class 0 OID 0)
-- Dependencies: 181
-- Name: metadata_id_metadata_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: csw_harvester
--
...
-- Name: responsibleparty; Type: TABLE; Schema: public; Owner: csw_harvester; Tablespace:
--
...
ALTER TABLE public.responsibleparty OWNER TO csw_harvester;

--
-- TOC entry 183 (class 1259 OID 49256)
-- Name: responsibleparty_id_responsibleparty_seq; Type: SEQUENCE; Schema: public; Owner: csw_harvester
--
...
ALTER TABLE public.responsibleparty_id_responsibleparty_seq OWNER TO csw_harvester;

--
-- TOC entry 2013 (class 0 OID 0)
-- Dependencies: 183
-- Name: responsibleparty_id_responsibleparty_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: csw_harvester
--
...
-- Name: sdi; Type: TABLE; Schema: public; Owner: csw_harvester; Tablespace:
--
...
ALTER TABLE public.sdi OWNER TO csw_harvester;

--
-- TOC entry 185 (class 1259 OID 49264)
-- Name: sdi_id_sdi_seq; Type: SEQUENCE; Schema: public; Owner: csw_harvester
--
...
ALTER TABLE public.sdi_id_sdi_seq OWNER TO csw_harvester;

--
-- TOC entry 2014 (class 0 OID 0)
-- Dependencies: 185
-- Name: sdi_id_sdi_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: csw_harvester
--
...
-- Name: id_dataidentification; Type: DEFAULT; Schema: public; Owner: csw_harvester
--
...
-- Name: id_sdi; Type: DEFAULT; Schema: public; Owner: csw_harvester
--
...
-- Name: id_geographicboundingbox; Type: DEFAULT; Schema: public; Owner: csw_harvester
--
...
-- Name: id_keyword; Type: DEFAULT; Schema: public; Owner: csw_harvester
--
...
-- Name: id_metadata; Type: DEFAULT; Schema: public; Owner: csw_harvester
--
...
-- Name: id_responsibleparty; Type: DEFAULT; Schema: public; Owner: csw_harvester
--
...
-- Name: contact_pkey; Type: CONSTRAINT; Schema: public; Owner: csw_harvester; Tablespace:
--
...
-- Name: dataidentification_pkey; Type: CONSTRAINT; Schema: public; Owner: csw_harvester; Tablespace:
--
...
-- Name: extraction_pkey; Type: CONSTRAINT; Schema: public; Owner: csw_harvester; Tablespace:
--
...
-- Name: geographicboundingbox_pkey; Type: CONSTRAINT; Schema: public; Owner: csw_harvester; Tablespace:
--
...
-- Name: keyword_pkey; Type: CONSTRAINT; Schema: public; Owner: csw_harvester; Tablespace:
--
...
-- Name: metadata_pkey; Type: CONSTRAINT; Schema: public; Owner: csw_harvester; Tablespace:
--
...
-- Name: responsibleparty_pkey; Type: CONSTRAINT; Schema: public; Owner: csw_harvester; Tablespace:
--
...
-- Name: sdi_pkey; Type: CONSTRAINT; Schema: public; Owner: csw_harvester; Tablespace:
--
...
-- Dependencies: 6
-- Name: public; Type: ACL; Schema: -; Owner: csw_harvester
--
...
-- Name: fk_contact_id_responsibleparty; Type: FK CONSTRAINT; Schema: public; Owner: csw_harvester
--
...
-- Name: fk_dataidentification_metadata; Type: FK CONSTRAINT; Schema: public; Owner: csw_harvester
--
...
-- Name: fk_extraction_id_metadata; Type: FK CONSTRAINT; Schema: public; Owner: csw_harvester
--
...
-- Name: fk_extraction_id_sdi; Type: FK CONSTRAINT; Schema: public; Owner: csw_harvester
--
...
-- Name: fk_geographicboundingbox_dataidentification; Type: FK CONSTRAINT; Schema: public; Owner: csw_harvester
--
...
-- Name: fk_keyword_id_dataidentification; Type: FK CONSTRAINT; Schema: public; Owner: csw_harvester
--
...
-- Dependencies: 293
-- Name: contact; Type: ACL; Schema: public; Owner: csw_harvester
--


REVOKE ALL ON SCHEMA public FROM PUBLIC;
REVOKE ALL ON SCHEMA public FROM csw_harvester;
GRANT ALL ON SCHEMA public TO csw_harvester;
GRANT ALL ON SCHEMA public TO PUBLIC;

-- Completed on 2016-10-24 09:24:27

--
-- csw_harvesterQL database dump complete
--
